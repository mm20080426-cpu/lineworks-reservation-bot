...
    // ★ 修正点: row[1] は userId、row[0] は reservationId
    const [, rowUserId, date, slot, , , , status] = row; 
    return rowUserId === userId && // ここで userId を比較
