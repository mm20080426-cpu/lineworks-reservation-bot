...
async function handleBotMessage(userId, messageText) {
  ...
  if (context?.step === 'awaiting_selection') {
    ...
    if (!selected.timeSlot || !selected.date) {
      console.warn('[WARN] timeSlotまたはdateが抽出できませんでした:', selected.display);
